...
PRINT STAT;
PLOT  HIST, RIGHT, KIND=electron, H=En/1D6, HSCALE=(146,151,100000),
        TITLE='Right-Going Electron Energy Spectrum;',
        HTITLE='E0e1 (MeV); X X      ;';
PLOT  HIST, RIGHT, KIND=photon, H=En/1D3, HSCALE=(0,420,100000),
        TITLE='All Photon Energy Spectrum;',
        HTITLE='E0G1 (keV); XGX      ;'  ;
PLOT  HIST, LEFT, KIND=photon, H=En, HSCALE=(1.3,1.5,100000),
        TITLE='All Photon Energy Spectrum;',
        HTITLE='E0G1 (eV); XGX      ;'  ;
STOP;
END;